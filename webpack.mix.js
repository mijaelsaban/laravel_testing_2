...
mix.copyDirectory('node_modules/feather-icons/dist', 'public/assets/plugins/feather-icons')
    ...
    .copyDirectory(
        ['node_modules/perfect-scrollbar/dist', 'node_modules/perfect-scrollbar/css'],
        'public/assets/plugins/perfect-scrollbar'
    )
    .copyDirectory(
        ['node_modules/prismjs/prism.js', 'node_modules/prismjs/plugins/normalize-whitespace/prism-normalize-whitespace.min.js', 'node_modules/prismjs/themes/prism.css'],
    ...
    .copyDirectory(
        ['node_modules/cropperjs/dist/cropper.min.js', 'node_modules/cropperjs/dist/cropper.min.css'],
    ...
    .copyDirectory(
        ['node_modules/sweetalert2/dist/sweetalert2.min.js', 'node_modules/sweetalert2/dist/sweetalert2.min.css'],
    ...
    .copyDirectory(
        ['node_modules/morris.js/morris.min.js', 'node_modules/morris.js/morris.css'],
    ...
    .copyDirectory(
        ['node_modules/datatables.net/js/jquery.dataTables.js', 'node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css'],
    ...
    .copyDirectory(
        ['node_modules/select2/dist/js/select2.js', 'node_modules/select2/dist/css/select2.min.css'],
        'public/assets/plugins/select2'
    )
    .copyDirectory(
        ['node_modules/simplemde/dist/simplemde.min.js', 'node_modules/simplemde/dist/simplemde.min.css'],
        'public/assets/plugins/simplemde'
    )
    .copyDirectory('node_modules/jquery-tags-input/dist', 'public/assets/plugins/jquery-tags-input')
    .copyDirectory(
        ['node_modules/dropzone/dist/min/dropzone.min.js', 'node_modules/dropzone/dist/min/dropzone.min.css'],
        'public/assets/plugins/dropzone'
    )
    .copyDirectory('node_modules/dropify/dist', 'public/assets/plugins/dropify')
    .copyDirectory(
        ['node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js', 'node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css'],
        'public/assets/plugins/bootstrap-colorpicker'
    )
    .copyDirectory(
        ['node_modules/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js', 'node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'],
        'public/assets/plugins/bootstrap-datepicker'
    )
    .copyDirectory(
        ['node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.js', 'node_modules/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css'],
    ...
    .copyDirectory(
        ['node_modules/jquery-steps/build/jquery.steps.min.js', 'node_modules/jquery-steps/demo/css/jquery.steps.css'],
    ...
    .copyDirectory(
        ['node_modules/fullcalendar/main.min.js', 'node_modules/fullcalendar/main.min.css'],
    ...
    .copyDirectory(
        ['node_modules/filepond/dist/filepond.js', 'node_modules/filepond/dist/filepond.css'],
        'public/assets/plugins/filepond'
    )
    .copyDirectory('node_modules/jquery-filepond/filepond.jquery.js', 'public/assets/plugins/jquery-filepond/filepond.jquery.js')
